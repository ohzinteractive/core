...
export class ParticleAttribute {
    ...
    build_RT(particle_count: any): RenderTarget<Texture>;
    swap_RT(): void;
    update(attribute_writter_scene: any): void;
    store_geometry_attribute_in_RT(attribute: any, RT: RenderTarget<Texture>, storage_material: any, attribute_writter_scene: any): void;
    get_texture(): Texture;
}
